...
public class DialogBox : Control
{
	...
	private readonly PackedScene _dialogResponsePreload = GD.Load<PackedScene>("res://DialogBox/DialogResponse/DialogResponse.tscn");
	...
	private void UpdateDialog()
	{
		...
		if (info.Contains("conditions"))
		{
			...
			ChangePart(((conditionsAreTrue) ? info["partIfTrue"] : info["partIfFalse"]) as string);
			return;
		}
